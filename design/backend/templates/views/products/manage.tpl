...
{$product_add_button_as_dropdown = ($product_add_button_as_dropdown || ("MULTIVENDOR"|fn_allowed_for && $runtime.company_id))|default:false}
        ...
        <div class="table-responsive-wrapper longtap-selection">
            ...
            <tr class="cm-row-status-{$product.status|lower} cm-longtap-target {$hide_inputs_if_shared_product} {if !$is_use_context_menu}longtap-selection-disable{/if}"
                ...
                >
                    ...
                    <td width="13%" class="{if $no_hide_input_if_shared_product}{$no_hide_input_if_shared_product}{/if} products-list__list-price" data-th="{__("price")}">
