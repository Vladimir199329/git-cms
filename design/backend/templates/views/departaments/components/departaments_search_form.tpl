...
<form name="departaments_search_form" action="{""|fn_url}" method="get" class="{$form_meta}">
    ...
    {capture name="simple_search"}
        <div class="sidebar-field">
            <label for="elm_name">{__("departament")}</label>
            <div class="break">
    ...
    {include file="common/advanced_search.tpl" no_adv_link=true simple_search=$smarty.capture.simple_search dispatch=$dispatch view_type="departaments"}
