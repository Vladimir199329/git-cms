<?php /* Smarty version Smarty-3.1.21, created on 2021-12-26 19:27:44
         compiled from "/home/vladimir/public_html/site.devel/git-cms/design/backend/templates/views/product_options/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:213367383661c89800c832f7-86055421%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '969252f7e7349d1223613e55cc0e5508f528eb4f' => 
    array (
      0 => '/home/vladimir/public_html/site.devel/git-cms/design/backend/templates/views/product_options/update.tpl',
      1 => 1639041538,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '213367383661c89800c832f7-86055421',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61c89800e266b6_85070349',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61c89800e266b6_85070349')) {function content_61c89800e266b6_85070349($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/home/vladimir/public_html/site.devel/git-cms/app/functions/smarty_plugins/modifier.enum.php';
...
if (!is_callable('smarty_function_math')) include '/home/vladimir/public_html/site.devel/git-cms/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('general','variants','position','type','description','comment','comment_hint','required','missing_variants_handling','display_message','hide_option_completely','regexp','regexp_hint','inner_hint','tt_views_product_options_update_inner_hint','incorrect_filling_message','tt_views_product_options_update_incorrect_filling_message','allowed_extensions','allowed_extensions_hint','max_uploading_file_size','max_uploading_file_size_hint','multiupload','position_short','name','modifier','type','weight_modifier','type','status','expand_collapse_list','expand_collapse_list','expand_collapse_list','expand_collapse_list','position_short','name','modifier','type','weight_modifier','type','status','expand_collapse_list','expand_collapse_list','expand_collapse_list','expand_collapse_list','icon','position','name','modifier','type','weight_modifier','type','status','expand_collapse_list','expand_collapse_list','expand_collapse_list','expand_collapse_list','extra','icon'));
?>
...
</th><th class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> hidden<?php }?>"><?php echo $_smarty_tpl->__("name");?>
</th><th><?php echo $_smarty_tpl->__("modifier");?>
&nbsp;/&nbsp;<?php echo $_smarty_tpl->__("type");?>
</th><th><?php echo $_smarty_tpl->__("weight_modifier");?>
&nbsp;/&nbsp;<?php echo $_smarty_tpl->__("type");?>
...
">
            <tr><td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> hidden<?php }?>"data-th="<?php echo $_smarty_tpl->__("position_short");?>
...
"size="3"class="input-micro"/></td><td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> hidden<?php }?>"data-th="<?php echo $_smarty_tpl->__("name");?>
"><input type="text"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
][variant_name]"value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vr']->value['variant_name'], ENT_QUOTES, 'UTF-8');?>
"class="input-medium"/></td><td class="nowrap <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_smarty_tpl->tpl_vars['shared_product']->value=="Y") {?> cm-no-hide-input<?php }?>"data-th="<?php echo $_smarty_tpl->__("modifier");?>
&nbsp;/&nbsp;<?php echo $_smarty_tpl->__("type");?>
"><input type="text"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
][modifier]"value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vr']->value['modifier'], ENT_QUOTES, 'UTF-8');?>
"size="5"class="input-mini cm-numeric" data-a-sep/>&nbsp;/&nbsp;<select class="input-xsmall" name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
...
</td><td class="nowrap" data-th="<?php echo $_smarty_tpl->__("weight_modifier");?>
&nbsp;/&nbsp;<?php echo $_smarty_tpl->__("type");?>
"><input type="text"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
][weight_modifier]"value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vr']->value['weight_modifier'], ENT_QUOTES, 'UTF-8');?>
"size="5"class="input-mini"/>&nbsp;/&nbsp;<select class="input-xsmall" name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
...
</option><option value="P" <?php if ($_smarty_tpl->tpl_vars['vr']->value['weight_modifier_type']=="P") {?>selected="selected"<?php }?>>%</option></select></td><td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> hidden<?php }?>"data-th="<?php echo $_smarty_tpl->__("status");?>
...
"><span class="icon-caret-down"></span></span><input type="hidden"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
...
</div></div><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"product_options:edit_product_options"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</td></tr>
            </tbody>
            <?php } ?>
...
"
            >
            <tr><td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> hidden<?php }?>"data-th="<?php echo $_smarty_tpl->__("position");?>
"><input type="text"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
][position]"value=""size="3"class="input-micro"/></td><td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> hidden<?php }?>"data-th="<?php echo $_smarty_tpl->__("name");?>
"><input type="text"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
][variant_name]"value=""class="input-medium"/></td><td class="nowrap" data-th="<?php echo $_smarty_tpl->__("modifier");?>
&nbsp;/&nbsp;<?php echo $_smarty_tpl->__("type");?>
"><input type="text"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
][modifier]"value=""size="5"class="input-mini cm-numeric" data-a-sep/>&nbsp;/&nbsp;<select class="input-xsmall" name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
...
</option><option value="P">%</option></select></td><td class="nowrap" data-th="<?php echo $_smarty_tpl->__("weight_modifier");?>
&nbsp;/&nbsp;<?php echo $_smarty_tpl->__("type");?>
"><input type="text"name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
][weight_modifier]"value=""size="5"class="input-mini"/>&nbsp;/&nbsp;<select class="input-xsmall" name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
...
</option><option value="P">%</option></select></td><td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> hidden<?php }?>"data-th="<?php echo $_smarty_tpl->__("status");?>
