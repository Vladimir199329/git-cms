        ...
        'actions' => [
            ...
            'items'    => [
                'delete_selected' => [
                    ...
                    'dispatch' => 'departaments.delete_departaments',
                    'data'     => [
...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'departaments.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('departaments.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'pagination_contents',
                'data-ca-target-form' => '#departaments_form',
            ],
        ],
        'position' => $position,
    ];
